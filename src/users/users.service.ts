...
export class UsersService {
  constructor(@InjectModel(User.name) private userModel: Model<User>) {} // truyền đối tượng thao tác với dữ liệu db nếu không có thì sẽ không biết cái nào để thao tác
